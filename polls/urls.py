...
urlpatterns = [
    path('econedmonth', views.education_month, name='education_month'),
    ...
    path("report-2022", views.report_2022, name="report-2022"),
    path("report-2023", views.report_2023, name="report-2023"),
    ...
    path("gala", views.gala_redirect, name="gala-redirect"),
    path("gala2024", views.gala_2024, name="gala-redirect"),
    path("caset", views.caset, name="caset"),
    path("1million", views.million, name="million"),
    path('captcha/', include('captcha.urls')),
    path("financial", views.financial_statements, name="financial-statements"),
